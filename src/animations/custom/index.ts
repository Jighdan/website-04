...
export const ANIMATIONS: Animation[] = [new MarqueeAnimations(), new ArrowAnimations(), new ParallaxImageAnimations(), new RotatingImageAnimations(), new RevealingTextAnimations(), new PinnedContentAnimations()];